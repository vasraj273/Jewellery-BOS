...
// Uploads are saved to the Render local disk and served by express.static
// at `/uploads`. The client's assetUrl() resolves the relative path against
// the API origin. (Note: Render disk is ephemeral — files are cleared on
// redeploy; the DB URL persists.)
